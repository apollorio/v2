...
<section class="section" id="events" aria-labelledby="events-title">
		...
		<div class="nh-section-head ai">
			<span class="grouped-left">
				...
				<div class="nh-month-dropdown">
					<button id="nhMonthTrigger" class="nh-month-trigger" aria-label="<?php esc_attr_e( 'Selecionar mês', 'apollo-templates' ); ?>">
			...
			<a href="<?php echo esc_url( home_url( '/eventos' ) ); ?>" aria-label="<?php esc_attr_e( 'Ver todos os eventos', 'apollo-templates' ); ?>">Ver Todos →</a>
		</div>
	...
	?>
						href="<?php echo esc_url( $permalink ); ?>" <?php endif; ?>
						class="a-v2-eve-C ai">
						...
						<div class="a-v2-eve-C__body">
							...
							<?php if ( $lineup_text ) : ?>
								<p class="a-v2-eve-C__meta"><i class="ri-sound-module-fill" aria-hidden="true"></i><span><?php echo esc_html( $lineup_text ); ?></span></p>
							<?php endif; ?>
							<?php if ( $location_text ) : ?>
								<p class="a-v2-eve-C__meta"><i class="ri-map-pin-2-line" aria-hidden="true"></i><span><?php echo esc_html( $location_text ); ?></span></p>
							<?php endif; ?>
							<?php if ( $genres_text ) : ?>
								<p class="a-v2-eve-C__meta"><i class="ri-music-2-line" aria-hidden="true"></i><span><?php echo esc_html( $genres_text ); ?></span></p>
							<?php endif; ?>
						</div>
					</a>
				<?php endwhile; ?>
			...
			<a href="<?php echo esc_url( home_url( '/eventos' ) ); ?>" class="a-v2-eve-C a-v2-eve-C--explore ai" aria-label="<?php esc_attr_e( 'Ver todos os eventos', 'apollo-templates' ); ?>">
				<div class="xp-inner">

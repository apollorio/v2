    ...
    <div class="container">
        <div class="nh-section-head ai">
            ...
            <a href="<?php echo esc_url(home_url('/djs')); ?>"
                aria-label="<?php esc_attr_e('Ver todos os lançamentos', 'apollo-templates'); ?>">Explore All →</a>
        </div>
        ...
        <div class="nh-tracks-grid">
            ...
            <?php if ($tracks_query->have_posts()) : ?>
                ...
                ?>
                    ...
                    ?>
                    <article class="nh-track-card reveal-up ai">
                        <div class="nh-track-artwork">
                            <img src="<?php echo esc_url($image); ?>" alt="<?php echo esc_attr(get_the_title()); ?>"
                                loading="lazy" />
                            <div class="nh-track-play-overlay" aria-hidden="true">
                                <button class="nh-track-play-btn"
                                    aria-label="<?php echo esc_attr(sprintf(__('Tocar %s', 'apollo-templates'), get_the_title())); ?>" <?php
                                                                                                                                                if ($soundcloud) :
                        ...
                        <div class="nh-track-info">
                            ...
                            <div class="nh-track-artist">
                                <?php echo esc_html(get_post_meta(get_the_ID(), '_dj_bio_short', true) ?: get_the_title()); ?>
                            </div>
                            <div class="nh-track-meta">
                                <span><i class="ri-headphone-line"></i><?php echo esc_html($genre); ?></span>
                                <span><i
                                        class="ri-play-circle-line"></i><?php echo esc_html(number_format_i18n(rand(500, 9999))); ?></span>
                            </div>
                        </div>
                    </article>
                <?php endwhile; ?>
            ...
            <a href="<?php echo esc_url(home_url('/djs')); ?>" class="reveal-up nh-track-card nh-explore-card ai"
                aria-label="<?php esc_attr_e('Ver todos os DJs', 'apollo-templates'); ?>">
                <div class="xp-inner">

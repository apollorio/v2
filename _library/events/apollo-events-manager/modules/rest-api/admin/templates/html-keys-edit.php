...
if (0 === intval($key_id)) {
    ...
    ?>
		<p class="submit">
			...
			<a class="aprio-backend-theme-button aprio-revoke-button" href="<?php echo esc_url(wp_nonce_url(add_query_arg([ 'revoke-key' => $key_id ], admin_url('edit.php?post_type=event_listing&page=aprio-rest-api-settings&tab=api-access')), 'revoke')); ?>"><?php esc_html_e('Revoke key', 'aprio-rest-api'); ?></a>
		</p>
		<?php
}
?>

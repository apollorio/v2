var APRIORestAPIAdmin = (function () {
	return {
		init: function () {
			...
			jQuery( ".aprio-app-branding-mode .app-branding-mode .aprio-light-mode" ).click(
				function () {
			...
			jQuery( ".aprio-app-branding-mode .app-branding-mode .aprio-dark-mode" ).click(
				function () {
			...
			toggleEventsRow();
			jQuery( 'input[name="event_show_by"]' ).change(
				function () {
			...
			jQuery( '.wp_event_manager_upload_file_button' ).on(
				'click',
				function (e) {
					e.preventDefault();
					...
					jQuery.ajax(
						{
							...
							data: {
								...
								mobile_menu: jQuery( 'input[name="mobile_menu[]"]:checked' ).map(
									function () {
										return this.value;
									}
								).get()

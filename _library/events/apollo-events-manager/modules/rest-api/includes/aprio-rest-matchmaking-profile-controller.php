...
class APRIO_REST_Matchmaking_Profile_Controller extends APRIO_REST_CRUD_Controller
{
    ...
    public function register_routes()
    {
        ...
        register_rest_route(
            ...
            [
                [
                    ...
                    'callback'            => [ $this, 'get_user_profile_data' ],
        ...
        register_rest_route(
            ...
            [
                [
                    ...
                    'callback'            => [ $this, 'update_compatibilidade_profile' ],
                    'permission_callback' => [ $this, 'permission_check' ],
                    'args'                => [],
                ],
            ]
        ...
        register_rest_route(
            ...
            [
                'methods'             => WP_REST_Server::READABLE,
                'callback'            => [ $this, 'get_compatibilidade_profile_settings' ],
                'permission_callback' => [ $this, 'permission_check' ],
                'args'                => [
                    'user_id' => [
                        'required' => false,
        ...
        register_rest_route(
            ...
            [
                'methods'             => WP_REST_Server::CREATABLE,
                'callback'            => [ $this, 'update_compatibilidade_profile_settings' ],
                'permission_callback' => [ $this, 'permission_check' ],
                'args'                => [
                    'user_id' => [
                        'required' => false,
    ...
    public function upload_user_file($request)
    {
        ...
        if (empty($_FILES['file'])) {
            return self::prepare_error_for_response(400, [ 'message' => 'No file uploaded.' ]);
        }
        ...
        if (! isset($movefile['url'])) {
            return self::prepare_error_for_response(500, [ 'message' => 'File upload failed.' ]);
        }

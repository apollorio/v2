...
class TemplateLoader {
	...
	public function __construct() {
		...
		add_filter( 'archive_template', [ $this, 'archive_event_template' ] );
	}
	 ...
	 * @param string $style    Estilo (vazio = ativo).
	 */
	public function render( string $filename, array $vars = [], string $style = '' ): void {
	 ...
	 */
	public function render_to_string( string $filename, array $vars = [], string $style = '' ): string {
		ob_start();

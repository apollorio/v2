            ...
            <a href="<?php echo esc_url( $evt['permalink'] ); ?>" class="av2-event-mini">
                ...
                <div class="av2-event-mini__info">
                    ...
                    <div class="av2-event-mini__meta">
                        ...
                        <?php if ( $evt['loc_name'] ) echo ' · ' . esc_html( $evt['loc_name'] ); ?>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    tl.from('.av2-hero__meta, .av2-dj-info__sounds, .av2-dj-socials', { y: 30, opacity: 0, duration: 0.8, stagger: 0.1, ease: 'power2.out' }, '-=0.6');

...
<head>
	...
	<!-- Open Graph -->
	<meta property="og:title" content="<?php echo esc_attr( $display_name ); ?> - <?php echo esc_attr( get_bloginfo( 'name' ) ); ?>">
	<meta property="og:type" content="profile">
	<meta property="og:url" content="<?php echo esc_url( home_url( '/id/' . $displayed_user->user_nicename . '/' ) ); ?>">
	...
	<!-- Profile Styles -->
	<link rel="stylesheet" href="<?php echo esc_url( APOLLO_LOGIN_URL . 'assets/css/profile.css?v=' . APOLLO_LOGIN_VERSION ); ?>">
			...
			<section class="profile-info-section">
				...
				<div class="profile-meta">
					<span class="meta-item">
						...
						<span>Membro desde <?php echo esc_html( date_i18n( 'M Y', strtotime( $displayed_user->user_registered ) ) ); ?></span>
					</span>
				</div>
			</section>
							...
							<div class="about-section">
								...
								<ul class="info-list">
									<li>
										...
										<span class="info-value">@<?php echo esc_html( $displayed_user->user_nicename ); ?></span>
									</li>
									<?php if ( ! empty( $instagram ) ) : ?>
									<li>
									...
									<li>
										...
										<span class="info-value"><?php echo esc_html( date_i18n( 'd/m/Y', strtotime( $displayed_user->user_registered ) ) ); ?></span>
									</li>
								</ul>
							</div>
						</div>

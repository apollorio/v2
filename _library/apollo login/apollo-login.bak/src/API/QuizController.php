	...
	public function register_routes(): void {
		...
		register_rest_route(
			...
			array(
				...
				'args'                => array(
					...
					'token'   => array( 'required' => false, 'type' => 'string' ),
				),
			)
		);
		...
		register_rest_route(
			...
			array(
				...
				'permission_callback' => '__return_true',
				'args'                => array(
					'level'    => array( 'required' => true, 'type' => 'integer' ),
					'sequence' => array( 'required' => true, 'type' => 'array' ),
					'success'  => array( 'required' => true, 'type' => 'boolean' ),
					'token'    => array( 'required' => false, 'type' => 'string' ),
				),
			)
		);

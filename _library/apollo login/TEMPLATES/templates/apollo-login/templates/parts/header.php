...
<header class="apollo-header" data-tooltip="<?php esc_attr_e( 'Cabeçalho Apollo', 'apollo-login' ); ?>">
	<!-- Matrix ASCII Art -->
	...
	<div class="logo-mark" data-tooltip="<?php esc_attr_e( '', 'apollo-login' ); ?>">
		<div class="logo-icon" data-tooltip="<?php esc_attr_e( '', 'apollo-login' ); ?>"></div>
		<div class="logo-text">
			<span class="brand" data-tooltip="<?php esc_attr_e( 'Projeto apollo::rio v2.0.0', 'apollo-login' ); ?>"><?php echo esc_html( $brand_name ); ?></span>
			<span class="sub" data-tooltip="<?php esc_attr_e( 'Subtítulo', 'apollo-login' ); ?>"><?php echo esc_html( $brand_subtitle ); ?></span>
		</div>
	</div>
	<div class="coordinates" data-tooltip="<?php esc_attr_e( 'Coordenadas e timestamp', 'apollo-login' ); ?>">
		<span data-tooltip="<?php esc_attr_e( 'Localização', 'apollo-login' ); ?>"><?php echo esc_html( $coordinates ); ?></span>
		<span id="timestamp" data-tooltip="<?php esc_attr_e( 'Data e hora atual UTC', 'apollo-login' ); ?>">

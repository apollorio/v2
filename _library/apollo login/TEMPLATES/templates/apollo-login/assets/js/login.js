...
(function() {
    ...
    async function handleLogin(e) {
        ...
        try {
            ...
            if (result.success) {
                handleLoginSuccess(result.data?.redirect);
            } else {
    ...
    function handleLoginSuccess(redirectUrl) {
        ...
        setTimeout(() => {
            window.location.href = redirectUrl || CONFIG.redirectAfterLogin;
        }, 1500);
    }
    ...
    async function submitRegistration() {
        ...
        try {
            ...
            if (result.success) {
                ...
                showNotification(result.data?.message || 'Erro ao processar cadastro.', 'error');
            }

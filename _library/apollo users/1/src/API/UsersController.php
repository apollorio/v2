...
class UsersController {
	...
	public function register_routes(): void {
		...
		register_rest_route( $this->namespace, '/users/(?P<username>[a-zA-Z0-9_-]+)', [
			'methods'             => \WP_REST_Server::READABLE,
			'callback'            => [ $this, 'get_user_by_username' ],
		...
		register_rest_route( $this->namespace, '/users', [
			'methods'             => \WP_REST_Server::READABLE,
			'callback'            => [ $this, 'get_users_directory' ],
			'permission_callback' => [ $this, 'check_can_view_directory' ],
			'args'                => [
				'page'     => [
					'default'           => 1,
		...
		register_rest_route( $this->namespace, '/users/(?P<id>\d+)', [
			'methods'             => \WP_REST_Server::EDITABLE,
			'callback'            => [ $this, 'update_user_by_id' ],
			'permission_callback' => [ $this, 'check_can_edit_user' ],
			'args'                => [
				'id' => [
					'required'          => true,
					'type'              => 'integer',
		...
		// User preferences
		register_rest_route( $this->namespace, '/users/(?P<id>\d+)/preferences', [
			'methods'             => \WP_REST_Server::READABLE,
			'callback'            => [ $this, 'get_user_preferences' ],
			'permission_callback' => [ $this, 'check_can_view_user' ],
			'args'                => [
				'id' => [
					'required'          => true,
					'type'              => 'integer',
		...
		// User matchmaking
		register_rest_route( $this->namespace, '/users/(?P<id>\d+)/matchmaking', [
			'methods'             => \WP_REST_Server::READABLE,
			'callback'            => [ $this, 'get_user_matches' ],
			'permission_callback' => [ $this, 'check_can_view_user' ],
			'args'                => [
				'id' => [
					'required'          => true,
		...
		// User fields
		register_rest_route( $this->namespace, '/users/(?P<id>\d+)/fields', [
			'methods'             => \WP_REST_Server::READABLE,
		...
		register_rest_route( $this->namespace, '/users/(?P<id>\d+)/fields', [
			'methods'             => \WP_REST_Server::EDITABLE,
			'callback'            => [ $this, 'update_user_fields' ],
			'permission_callback' => [ $this, 'check_can_edit_user' ],
			'args'                => [
				'id' => [
					'required'          => true,
		...
		// User radar
		register_rest_route( $this->namespace, '/users/radar', [
			'methods'             => \WP_REST_Server::READABLE,
			'callback'            => [ $this, 'get_radar_users' ],
			'permission_callback' => [ $this, 'check_can_view_directory' ],
			'args'                => [
				'limit'    => [
					'default'           => 50,
		...
		// Public profile data
		register_rest_route( $this->namespace, '/profile/(?P<username>[a-zA-Z0-9_-]+)', [
			'methods'             => \WP_REST_Server::READABLE,
		...
		// Record profile view
		register_rest_route( $this->namespace, '/profile/(?P<username>[a-zA-Z0-9_-]+)/view', [
			'methods'             => \WP_REST_Server::CREATABLE,
			'callback'            => [ $this, 'record_profile_view' ],
			'permission_callback' => '__return_true',
			'args'                => [
				'username' => [
					'required'          => true,
	...
	public function update_user_by_id( \WP_REST_Request $request ) {
		...
		return new \WP_REST_Response( [ 'message' => 'Update not implemented yet' ], 200 );
	}
	...
	public function search_users( \WP_REST_Request $request ) {
		...
		$data = array_map( [ $this, 'prepare_user_data' ], $users );

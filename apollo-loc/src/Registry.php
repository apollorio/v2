...
class Registry {
	...
	public function render_metabox( \WP_Post $post ): void {
		...
		?>
		<style>
			.apollo-local-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 16px; }
			.apollo-local-field { margin-bottom: 12px; }
			.apollo-local-field label { display: block; font-weight: 600; margin-bottom: 4px; font-size: 13px; }
			.apollo-local-field input,
			.apollo-local-field select { width: 100%; padding: 6px 8px; }
			.apollo-local-full { grid-column: 1 / -1; }
		</style>

		...
		<div class="panel">
			...
			<div class="panel-body">
				...
				<div class="toggle-row"><label class="switch"><input type="checkbox" name="apollo[loc_nearby]" value="1" <?php checked( $apollo['loc_nearby'] ?? true ); ?>><span class="switch-track"></span></label>
					<div class="toggle-text"><span class="toggle-title"><?php esc_html_e( 'Enable Nearby Search', 'apollo-admin' ); ?></span><span class="toggle-desc"><?php esc_html_e( 'Enable nearby venues search (Haversine formula)', 'apollo-admin' ); ?></span></div>
				</div>

		...
		<div class="panel">
			...
			<div class="panel-body">
				<div class="toggle-row"><label class="switch"><input type="checkbox" name="apollo[fav_enable]" value="1" <?php checked( $apollo['fav_enable'] ?? true ); ?>><span class="switch-track"></span></label>
					<div class="toggle-text"><span class="toggle-title"><?php esc_html_e( 'Enable Favorites', 'apollo-admin' ); ?></span><span class="toggle-desc"><?php esc_html_e( 'Enable the favorites/bookmark system', 'apollo-admin' ); ?></span></div>
				</div>

...
<form id="register-form" method="post" data-tooltip="<?php esc_attr_e('Formulário de registro', 'apollo-social'); ?>">
    ...
    <div class="form-group" data-tooltip="<?php esc_attr_e('Campo de nome', 'apollo-social'); ?>">
        <label for="nome"><?php esc_html_e('Nome social', 'apollo-social'); ?> <span
                style="color: var(--color-accent);">*</span></label>
        <div class="input-wrapper">
            <span class="input-prefix">></span>
            <input type="text" id="nome" name="nome"
                placeholder="<?php esc_attr_e('Nome que se identifica; vulgo seu nome', 'apollo-social'); ?>"
    ...
    <?php if ($show_instagram) : ?>
        ...
        <div class="form-group" data-tooltip="<?php esc_attr_e('Campo de Instagram', 'apollo-social'); ?>">
            ...
            <div class="input-wrapper">
                <span class="input-prefix" style="color: var(--color-accent);margin-right:-5px; font-weight: bold;"
                    data-tooltip="<?php esc_attr_e('Prefixo fixo @', 'apollo-social'); ?>">@</span>
                <input type="text" id="instagram" name="instagram"
                    placeholder="<?php esc_attr_e('seu_user', 'apollo-social'); ?>" autocomplete="off"
                    style="padding-left: 26px;"
                    data-tooltip="<?php esc_attr_e('Digite apenas seu user sem @', 'apollo-social'); ?>">
            </div>
        ...
        <div style="display: flex; gap: 12px; margin-bottom: 12px;">
            <label class="custom-toggle doc-type-toggle" data-type="cpf"
                ...
                <div class="toggle-track"
                    style="width: auto; padding: 7px 18px 9px!important; line-height:1.5!important; border-radius: 50px;">
                    <span
                        style="font-size: 11px;">&nbsp;&nbsp;<?php esc_html_e('CPF', 'apollo-social'); ?>&nbsp;&nbsp;</span>
                </div>
            </label>
            <label class="custom-toggle doc-type-toggle" data-type="passport"
                ...
                <div class="toggle-track"
                    style="width: auto; padding: 7px 18px 9px!important; line-height:1.5!important; border-radius: 50px;">
                    <span
                        style="font-size: 11px;">&nbsp;&nbsp;<?php esc_html_e('Passaporte', 'apollo-social'); ?>&nbsp;&nbsp;</span>
                </div>
            </label>
        </div>
    ...
    <div class="form-group" id="cpf-field" data-tooltip="<?php esc_attr_e('Campo de CPF', 'apollo-social'); ?>">
        <label for="cpf"><?php esc_html_e('Número do CPF', 'apollo-social'); ?> <span
                style="color: var(--color-accent);">*</span></label>
        <div class="input-wrapper">
            <span class="input-prefix">></span>
        ...
        <p class="small-note">
            <?php esc_html_e('Necessário para assinatura digital de documentos dentro do apollo::rio.', 'apollo-social'); ?>
        </p>
    </div>

...
<header class="apollo-header" data-tooltip="<?php esc_attr_e('Cabeçalho Apollo', 'apollo-social'); ?>">
    ...
    <div class="logo-mark" data-tooltip="<?php esc_attr_e('', 'apollo-social'); ?>">
        <div class="logo-icon" data-tooltip="<?php esc_attr_e('', 'apollo-social'); ?>"></div>
        <div class="logo-text">
            <span class="brand" data-tooltip="<?php esc_attr_e('Projeto apollo::rio v2.0.0', 'apollo-social'); ?>"><?php echo esc_html($brand_name); ?></span>

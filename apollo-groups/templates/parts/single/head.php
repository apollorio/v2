 ...
 * Single Part — Head
 *
 * HTML head with meta, CDN, GSAP, ScrollTrigger, Navbar, CSS.
...
if (defined('APOLLO_GROUPS_URL')) {
    $groups_css_url = APOLLO_GROUPS_URL . 'assets/css/single-group.css';
} else {
    $groups_css_url = plugin_dir_url(dirname(__DIR__)) . 'assets/css/single-group.css';
}
...
<head>
    ...
    <title>Apollo · <?php echo esc_html($group_name); ?></title>
